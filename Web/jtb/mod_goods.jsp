	...
	<body>
		...
		<%if(user.equals("admin")){%>
			<form action="add.jsp?user=<%=user%>" method="post" enctype="multipart/form-data" name="addGoods">
				<span style="font-weight:bold;">物品名称：</span><input type="text" name="name" value="<%=name%>"><br/>
				<p><span style="font-weight:bold;">商品图片：</span><input type="file" name="pic" value="<%=pic%>"></p>
				<p><span style="font-weight:bold;">物品价格：</span><input type="text" name="price" value="<%=price%>"></p>
				<p><span style="font-weight:bold;">物品简介：</span><input type="text" name="info" value="<%=info%>"></p>
				<p><span style="font-weight:bold;">物品数量：</span><input type="text" name="quantity" value="<%=quantity%>"></p>
				<p><span style="font-weight:bold;">物品分类：</span><input type="radio" name="class" value="服装饰品" <%=cla.equals("服装饰品")?"checked":""%>>服装饰品&nbsp&nbsp
				<input type="radio" name="class" value="童装玩具" <%=cla.equals("童装玩具")?"checked":""%>>童装玩具&nbsp&nbsp
				<input type="radio" name="class" value="生活百货" <%=cla.equals("生活百货")?"checked":""%>>生活百货&nbsp&nbsp
				<input type="radio" name="class" value="运动户外" <%=cla.equals("运动户外")?"checked":""%>>运动户外&nbsp&nbsp
				<input type="radio" name="class" value="数码优品" <%=cla.equals("数码优品")?"checked":""%>>数码优品&nbsp&nbsp
				<input type="radio" name="class" value="文教乐器" <%=cla.equals("文教乐器")?"checked":""%>>文教乐器&nbsp&nbsp</p>
				<p id="btn">
